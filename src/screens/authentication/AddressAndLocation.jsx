...
const AddressAndLocation = () => {
    ...
    return (
        <View style={styles.container}>
            <View>
                <Text style={styles.login}>Addressing</Text>
            </View>
            <View style={styles.inputcontainer}>
                <View style={styles.input}>
                    <Text style={styles.name}>Enter Country</Text>
                ...
                <View style={styles.input}>
                    <Text style={styles.name}>Enter City </Text>
                ...
                <View style={styles.input}>
                    <Text style={styles.name}>Enter Shop NO</Text>
                    <TextInput placeholder='Enter Shop NO'
                        placeholderTextColor={'black'}
                        style={styles.inputfield}
                        keyboardType='numeric'
                    />
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ProfilingandImages')}>
